                ...
                <div className='mx-6 '>
                    {
                        project.map((data, index) => (
                            <div className={`mt-12 flex justify-around gap-10  items-center ${index % 2 == 0 ? 'flex-row-reverse' : 'flex-row'}`} key={data.id}>
                                ...
                                <div className='w-90 flex flex-col gap-2'>
                                    ...
                                    <p className='text-sm text-[#A0A0A0] md:text-xl'>{data.language}</p>
                                    <ul>
